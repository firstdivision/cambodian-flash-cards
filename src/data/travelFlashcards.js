export const travelFlashcards = [
  ...
  { english: 'How much?', khmer: 'ប៉ុន្មាន?', phonetic: 'pon-maan?' },
  { english: 'Water', khmer: 'ទឹក', phonetic: 'teuk' },
  {
    english: 'Where is the bathroom?',
    khmer: 'បន្ទប់ទឹកនៅឯណា?',
    phonetic: 'bon-tup teuk nov ae-na?',
  },
  { english: 'Help!', khmer: 'ជួយផង!', phonetic: 'joo-ee phong!' },
]
